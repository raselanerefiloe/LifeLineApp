            ...
            <div class="col-span-2">
                ...
                <div class="bg-[#ACCF46] p-6 rounded-lg shadow-md mb-8">
                    <div class="flex gap-4">
                        <h2 class="text-xl font-bold text-green-600 mb-4 bg-white py-2 px-2 inline-block rounded-lg">
                            4.9
                            <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                        </h2>
                        <h3 class="text-2xl font-semibold mb-2">Top Pharmaceutical Industry Supplier</h3>
                    </div>
                    <p class="text-gray-700 mb-4">Your Trusted Partner in Quality</p>
                    <p class="text-gray-600 mb-6">LifeLine offers top-tier products that stand out in the market</p>
                    <a href="#"
                        class="inline-block bg-green-600 text-white px-6 py-2 rounded-lg shadow hover:bg-green-700">
                        Shop Now
                    </a>
                </div>
